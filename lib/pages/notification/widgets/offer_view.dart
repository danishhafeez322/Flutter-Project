    ...
    return (FirebaseAuth.instance.currentUser != null)? Container(
      ...
      child: Padding(
        ...
        StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            stream: FirebaseFirestore.instance.collection('/order').doc(FirebaseAuth.instance.currentUser!.uid).collection('offer').snapshots(),
            builder: (_, snapshot) {
                    ...
                    return 
                            ...
                            //   ((FirebaseAuth.instance.currentUser!.uid == data['senderName'])? 
                                  OfferViewDetail( 
                                    ...
                                    date: 'rent: ${data['price']} - gaurantee ${data['gaurantee_price']}',
